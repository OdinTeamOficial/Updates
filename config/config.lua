...
Config.props = {
  [1] = { 
    propcasa = "xs_prop_ar_tunnel_01a", -- NOME DO PROP 1 (PRINCIPAL)
    propportao = "prop_gate_military_01", -- NOME DO PROP 2 (PORTÃO)
    propfecha = "xs_prop_arena_wall_01b", -- NOME DO PROP 3
    proppilar = "xs_prop_arena_wall_01c", -- NOME DO PROP 4
    offsetfecha = vec3(4.8,5,0.5), -- POSIÇÃO DO PROP 3 EM RELAÇÃO AO PROP 1
    offsetpilar = vec3(-4.7,-5,0.3), -- POSIÇÃO DP PROP 4 EM RELAÇÃO AO PROP 1.
    offsetportao = vec3(-5,5,-0.3), -- POSIÇÃO DO PROP 2 EM RELAÇÃO AO PROP 1.
    vip = 0, -- SE O PROP É PARA VIPS OU NÃO
    max = 1, -- MAXIMO DESTE TIPO DE CONSTRUÇÃO POR PLAYER
    item = "agua" -- NOME DO ITEM UTILIZADO PARA CONSTRUIR
  },
}

Config.Linguagem = 'pt' -- LINGUAGEM UTILIZADA EM RELAÇÃO À CONFIGURAÇÃO DE TEXTO
Config.itemraid = "vodka" -- ITEM PARA PLAYERS ABRIREM OUTRAS BASES
Config.botaoraid = 246 -- BOTÃO PARA INICIAR O RAID
Config.botaocodigo = 38 -- BOTÃO PARA ABRIR O PAINEL DE CÓDIGO DA BASE
Config.tempo_explosao = 5000 -- TEMPO PARA EXPLODIR A BOMBA NO RAID

Config.anim = true -- FAZER ANIMAÇÃO PARA CONSTRUIR A BASE
Config.animdicteobj = {"amb@world_human_hammering@male@base","base","prop_tool_hammer"} -- DICIONARIO DE ANIMAÇÃO E OBJETO PARA CONSTRUIR A BASE


Config.comandovercasas = "verminhacasa" -- COMANDO PARA VER AS BASES DO PLAYER NO MAPA
Config.temposumirblip = 20000 -- TEMPO PARA SUMIR O BLIP DO MAPA
Config.tempoconstruir = 5000 -- TEMPO PARA CADA "MARTELADA"
Config.transparencia = 80 -- TRANSPARENCIA DOS PROPS ANTES DE FINALIZAR A CONSTRUÇÃO

Config.notifystypes = { -- TIPOS DE NOTIFICAÇÃO DA SUA BASE
  "sucesso", -- NOME DA NOTIFICAÇÃO PARA ALGO BEM SUCEDIDO
  "negado", -- NOME DA NOTIFICAÇÃO PARA ALGO MAL SUCEDIDO
  "importante" -- NOME DA NOTIFICAÇÃO PARA ALGO IMPORTANTE
}

Config.botoes = { -- BOTÕES E SEUS RESPECTIVOS TEXTOS PARA POSICIONAR A BASE
    ["girardireita"] = {38,"~b~ Pressione ~r~ E ~b~ para girar para a DIREITA."},
    ["giraresquerda"] = {264,"~b~ Pressione ~r~ Q ~b~ para girar para a ESQUERDA."},
    ["rotdireita"] = {160,"~b~Pressione ~r~ 3 ~b~ para rotacionar para a DIREITA."},
    ["rotesquerda"] = {164,"~b~Pressione ~r~ 4 ~b~ para rotacionar para a ESQUERDA."},
    ["inclinarfrente"] = {113,"~b~Pressione ~r~ G ~b~ para inclinar para a FRENTE."},
    ["inclinartras"] = {20,"~b~Pressione ~r~ Z ~b~ para inclinar para TRÁS."},
    ["fixar"] = {246,"~b~Pressione ~r~ Y ~b~ para FIXAR"},
    ["cancelar"] = {74,"~b~Pressione ~r~ H ~b~ para CANCELAR"},
    ['Construir'] = {38,"~g~Pressione ~r~ E ~g~ para construir"}
}
...
local labels = { -- LINGUAGENS
    ['pt'] = {
      ...
      ['Map_marker_nohomes'] = "Você não possui casa!",
      ['Max_homes'] = "Você só pode ter %d casa deste tipo",
      ['Sucess_created'] = "Casa criada com sucesso! Código do portão: <b> %s </b> Esté é o código de acesso à casa! Para ve-lo novamente, digite /%s",
      ['Unlocked'] = "~g~Destrancada",
      ['Locked'] = "~r~Trancada",
      ['Raid_msg'] = "~b~Pressione ~r~Y~b~ para Colocar uma C4",
      ['notify_explosion'] = "A bomba irá explodir em %d segundos, se afaste."
    ...
    ['en'] = {
      ...
      ['Construct_progress'] = "Riding...",
      ['Map_marker_homes'] = "Their houses <b>and passwords</b> were marked on the map, they were available for 20 seconds!",
      ['Map_marker_nohomes'] = "You don't own a home!",
      ['Max_homes'] = "You can only have %d houses of this type",
      ['Sucess_created'] = "House created successfully! Gate code: <b> %s </b> This is the access code to the house! To see it again, type /%s",
      ['Unlocked'] = "~g~Unlocked",
      ['Locked'] = "~r~Locked",
      ['Raid_msg'] = "~b~Pressione ~r~Y~b~ para Colocar uma C4",
