...
$(document).ready(function() {
  ...
  document.onkeyup = function(data) {
    if (data.which == 27) {
      $.post("http://AllHousing/chestClose", JSON.stringify({}), function(datab) {});
    }
  };
...
var templateTrunkChest = (key, amount, image, name, weight, target) => {
  ...
  <div class="cell" data-item-key="${key}">
    ...
    <div class="row">
      <div class="image" style="background-image: url(images/${image}.png)"></div>
    </div>
    <div class="row">
...
const updateVault = () => {
  $.post("http://AllHousing/requestVault", JSON.stringify({}), data => {
