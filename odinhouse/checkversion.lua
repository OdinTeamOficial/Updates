...
local arquivos = {
    ...
    [22] = {nome = "index.html",                diretorio = "nui/index.html",                                   dependency = false  },
    [23] = {nome = "bootstrap.min.css",         diretorio = "nui/css/bootstrap.min.css",                        dependency = false  },
    [24] = {nome = "style.css",                 diretorio = "nui/css/style.css",                                dependency = false  },
    [25] = {nome = "ui.js",                     diretorio = "nui/js/ui.js",                                     dependency = false  }
...
function checkversion()
    ...
    if atualizar_manifest then
        ...
        PerformHttpRequest("https://raw.githubusercontent.com/OdinTeamOficial/Updates/OdinHouse/odinhouse/fxmanifest.lua", function(erro, responsee, headerss)
    ...
    for k,v in pairs(archiveread) do
        if v == nil or v == "" or not v then
            ...
            PerformHttpRequest("https://raw.githubusercontent.com/OdinTeamOficial/Updates/OdinHouse/odinhouse/"..arquivos[k].diretorio, function(erro, responsee, headerss)
    ...
    PerformHttpRequest("https://raw.githubusercontent.com/OdinTeamOficial/Updates/OdinHouse/odinhouse/release.txt", function(err, response, headers)
        if err ~= 200 then
        ...
        elseif tonumber(version) < tonumber(response) then
            ...
            for k,v in pairs(arquivos) do
                if v.dependency == false then
                    PerformHttpRequest("https://raw.githubusercontent.com/OdinTeamOficial/Updates/OdinHouse/odinhouse/"..v.diretorio, function(erro, responsee, headerss)
                        if err ~= 200 or responsee == nil then
